...
## Deployment
We use grunt-sftp-deploy to move the files over sftp to the server. To deploy run 'npm run deploy'

You will need to have a .ftppass file in the root of the project directory that looks like this:

```
{
  "key": {
    "username"    : "nycedu",
    "keyLocation" : "/where/your/authorized/ssh/key/is"
  }
}
```
If you do not have an authorized ssh key, please reach out to sean@mobility-labs.com to become authorized.
